...
class SegmentationWithCoAttention(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        left_losses = nn.CrossEntropyLoss()(left_image_outputs, batch['left_bit_mask'])
        right_losses = nn.CrossEntropyLoss()(right_image_outputs, batch['right_bit_mask'])
    ...
    def validation_step(self, batch, batch_index):
        ...
        overall_loss = left_losses + right_losses
        self.log("val/left_losses", left_losses, on_step=True, on_epoch=True)
        self.log("val/right_losses", right_losses, on_step=True, on_epoch=True)
    ...
    def forward(self, batch):
        ...
        # )
        return (left_image_decoded_features, right_image_decoded_features)
